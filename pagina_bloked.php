...
<head>
	...
	<head lang="pt-br">
      ...
      <script> alert("Seu usuario está bloqueado por tentar mais de 5 vezes entre em contato com o Administrador !!"); </script>
	  <title>Sistema Odontológico</title>
	</head>
        ...
        <div id="loginbox" style="margin-top:200px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">Sistema Odontológico | Login</div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" action="login.php" method="POST" class="form-horizontal" role="form" data-toggle="validator">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="inputPassword" type="password" class="form-control" name="password" placeholder="Digite sua senha">
                                    </div>
